...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFF0792E);
  late Color tertiary = const Color(0xFF144CB8);
  late Color alternate = const Color(0xFF202428);
  late Color primaryText = const Color(0xFF2D2D2D);
  late Color secondaryText = const Color(0xFF2D2D2D);
...
class ThemeTypography extends Typography {
  ...
  String get displayMediumFamily => 'Arvo';
  ...
  String get displaySmallFamily => 'Arvo';
